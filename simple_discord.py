...
def simple_discord():
    ...
    tk.Button(main_window, text="Send Message", command=sendawebhok,
              bd="0", fg="#ffffff", bg="#738ADB",).grid(row=1, column=1)
    tk.Button(main_window, text="Settings", command=settings, width="20",
              bd="0", fg="#ffffff", bg="#738ADB").grid(row=2, column=1)
    tk.Button(main_window, text="Exit", command=bye, width="20",
              bd="0", fg="#ffffff", bg="#738ADB",).grid(row=3, column=1)
    tk.Label(main_window, text=__version__, fg="#ffffff",
